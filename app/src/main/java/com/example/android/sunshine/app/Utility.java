...
public class Utility {
    private static final char EMOJI_CLOUDS = '\u2601';
    private static final char EMOJI_CLEAR  = '\u2600';
    private static final char EMOJI_RAIN   = '\u2614';
    private static final char EMOJI_SNOW   = '\u2744';
    ...
    public static char getEmojiForWeatherCondition(int weatherId)
    {
        // Based on weather code data found at:
        // http://bugs.openweathermap.org/projects/api/wiki/Weather_Condition_Codes
        if (weatherId >= 200 && weatherId <= 232) {
